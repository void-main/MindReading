...
public class WriteActivity extends Activity {
	...
	private static final String TAG = WriteActivity.class.getCanonicalName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		writeTagHint.setText(R.string.write_tag_hint);
	...
	private void write(Tag tag) throws IOException, FormatException {
		NdefRecord mimeRecord = NdefRecord.createMime(this.getResources().getString(R.string.magic_mime_string), "".getBytes(Charset.forName("US-ASCII")));
		NdefMessage rawMessage = new NdefMessage(mimeRecord);
